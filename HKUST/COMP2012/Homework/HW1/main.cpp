...
int main() {
    ...
    // own test try out copy constructor
    // PlayerList test = PlayerList(list);
    // int k = test.getNumPlayers();
    // printf("%d",k);
    // if(k!=0)
    // {
    //     for(int i=0;i<2;i++)
    //         temp->getPlayer(i)->print();
    // }

    // own test try out splice function
    // PlayerList* temp=list.splice(2, 4);
    // int k = temp->getNumPlayers();
    // printf("%d\n:",k);
    // if(k!=0)
    // {
    //     for(int i=0;i<2;i++)
